...
Ready to send. Replace only the bracketed link placeholders with the real URLs
from `01-external-resources.md`. Akshat approves every message before it goes
out.

**Voice check before sending anything.** Reject any draft containing hype,
"exclusive", "premier", "ecosystem", "networking opportunity", credential gates,
startup-only framing, promised turnout, or a public WhatsApp link.

---

## 1. Founding post (Instagram, LinkedIn)
    ...
    Read about it and RSVP: [WEBSITE URL]
    Join the community: [JOIN FORM URL]

---

## 2. Individual outreach (direct message)

Personalise the first sentence from something the person has actually posted or
built. Do not invent familiarity.
...
Post only where the subreddit rules allow it. Check each one first.
    ...
    Event details and RSVP: [WEBSITE URL]

---

## 7. WhatsApp welcome (send on adding someone)
...
## 8. 48-hour reminder (Luma blast + WhatsApp)

    Lambda House Kanpur #01 is this Sunday, September 6, from 4:00–6:00 PM.

    Venue: [EXACT VENUE NAME AND MAP LINK]
